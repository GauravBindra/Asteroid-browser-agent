...
from form_automation_final import automate_easy_form
    ...
    try:
        ...
        with nova:
            ...
            if args.form == "easy":
                ...
                success = automate_easy_form(nova, form_data)
                
                # Take final screenshot after submission
                if args.screenshots:
                    screenshot_path = generate_screenshot_path(args.form, "completed")
                    capture_full_page_screenshot(nova, screenshot_path)
                ...
                if success:
                    ...
                    logger.warning("Form automation encountered issues")
                    return 1
            else:
