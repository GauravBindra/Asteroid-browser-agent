#!/usr/bin/env python3
"""
Test script for hard_form_automation8.py implementation
Testing the simplified fill_contact_details() function without extra clicks
"""
...
from hard_form_automation8 import fill_contact_details
...
def run_tests():
    """
    Run tests for the simplified fill_contact_details function.
    Tests complete filling of the Contact Details section without extra clicks.
    """
    logger = setup_logging()
    logger.info("Starting simplified Contact Details section test (no extra clicks)")
    ...
    try:
        ...
        with nova:
            ...
            # Note: force_navigation=False because the form starts on this tab
            logger.info("TEST: Filling Contact Details section with simplified commands")
            ...
            input("Simplified Contact section test PASSED! Press Enter to continue...")
            return 0
