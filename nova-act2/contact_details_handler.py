"""
Contact Details section handler for the Asteroid Form Challenge.
Responsible for filling all fields in the Contact Details section.
"""
...
def handle_contact_details(nova: NovaAct, form_data: dict) -> bool:
    """
    Handle the Contact Details section of the form.
    ...
    """
    logger.info("Processing Contact Details section")
